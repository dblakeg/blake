...
import sty from "./PlasmicNavigationBar.module.css"; // plasmic-import: EhZavOzgDizE/css
  ...
  return (
    <NavigationBar
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ltj02)}
          displayHeight={"auto"}
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__cBn75)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}

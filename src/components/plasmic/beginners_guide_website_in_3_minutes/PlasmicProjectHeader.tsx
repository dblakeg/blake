...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: Qcpi-BA5s5Ra/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__eSd1)}>
        <div className={classNames(projectcss.all, sty.column__peIs)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__g92Ko)}>
          <div className={classNames(projectcss.all, sty.columns__y9A0S)}>
            <div className={classNames(projectcss.all, sty.column__mdTdW)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__w8ZqQ)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__pnZo7)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__sdd57)}>
                {renderPlasmicSlot({
